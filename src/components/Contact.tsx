                ...
                <div className="grid md:grid-cols-2 gap-10">
                    ...
                    <div className="bg-gray-50 rounded-xl md:p-12 p-4">
                        <form className="space-y-4">
                            ...
                            <select
                                className="w-full border border-gray-300 bg-white rounded-xl px-4 py-3 text-gray-500 focus:outline-none focus:ring-2 focus:ring-[#3498DB]"
                            >
                            ...
                            <div className="space-y-6 text-gray-700 text-md">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-medium text-black text-lg">(215) 269-7830</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-medium text-black text-lg">info@hamilton.com</p>
                                    </div>
                                </div>
