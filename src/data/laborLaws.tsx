    ...
    content: (
      <div className="">
        <ul className="list-disc pl-4 sm:pl-6">
          <li className="text-base lg:text-base text-[#758599]">
  ...
  },
  {
    ...
    content: (
      <div className="">
        ...
        <ul className="list-disc pl-4 sm:pl-6">
          <li className="text-base lg:text-base text-[#05162A]  ">
          ...
          <li className="text-base lg:text-base text-[#05162A]">
            <strong className="text-[#05162A]">Overtime :</strong> 1.5
            <span className="text-[#758599] ">
              times regular rate for hours worked beyond 40 in a workweek Spread
